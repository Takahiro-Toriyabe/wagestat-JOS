/*-----------------------------------------------------------------------------
    ...
    Source: 
    Date: 2020/08/12 19:16:31
-----------------------------------------------------------------------------*/

capture log close _all

global DoFilePathTemp = "${path_import}/chingin"
global DataFilePathTemp = "${path_chosa_chingin}"
...
forvalues y = 18(1)29 {
	...
	save "${DataFilePathTemp}/chingin_h`y'_str.dta", replace
	destring *, replace
	run "${DoFilePathTemp}/h`y'/h`y'_val.do"
	run "${DoFilePathTemp}/h`y'/h`y'_validate.do"
	save "${DataFilePathTemp}/chingin_h`y'.dta", replace
}

clear
append using ///
    "${DataFilePathTemp}/chingin_h24_str.dta" ///
    "${DataFilePathTemp}/chingin_h25_str.dta" ///
    "${DataFilePathTemp}/chingin_h26_str.dta" ///
    "${DataFilePathTemp}/chingin_h27_str.dta" ///
    "${DataFilePathTemp}/chingin_h28_str.dta" ///
    "${DataFilePathTemp}/chingin_h29_str.dta" ///
	"${DataFilePathTemp}/chingin_h18_str.dta" ///
	"${DataFilePathTemp}/chingin_h19_str.dta" ///
	"${DataFilePathTemp}/chingin_h20_str.dta" ///
	"${DataFilePathTemp}/chingin_h21_str.dta" ///
	"${DataFilePathTemp}/chingin_h22_str.dta" ///
	"${DataFilePathTemp}/chingin_h23_str.dta" ///
...
save "${DataFilePathTemp}/chingin.dta", replace
